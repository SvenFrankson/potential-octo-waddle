...
class MainMenu {
    static Open(guiTexture) {
        ...
        let playButton = BABYLON.GUI.Button.CreateImageOnlyButton("play-button", "./img/play-button.png");
        ...
        let optionsButton = BABYLON.GUI.Button.CreateImageOnlyButton("options-button", "./img/options-button.png");
        ...
        let aboutButton = BABYLON.GUI.Button.CreateImageOnlyButton("about-button", "./img/about-button.png");
        ...
        let licenceButton = BABYLON.GUI.Button.CreateImageOnlyButton("licence-button", "./img/licence-button.png");
